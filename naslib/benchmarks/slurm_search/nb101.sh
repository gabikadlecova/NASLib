...
bash $BASE_DIR/nas_predictors/run_nas_search.sh $1 $BASE_DIR/saved_features/nasbench101-cifar10.pickle \
    $BASE_DIR/../../../zc_combine/data/nb101_nets.csv $2 $3 nasbench101 cifar10 $4
