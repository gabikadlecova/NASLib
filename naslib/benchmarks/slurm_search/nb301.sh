...
bash $BASE_DIR/nas_predictors/run_nas_search.sh $1 $BASE_DIR/saved_features/nasbench301-cifar10.pickle \
    $BASE_DIR/../../../zc_combine/data/nb301_nets.csv $2 $3 nasbench301 cifar10 $4
